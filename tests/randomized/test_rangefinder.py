...
from lowrank.randomized import rangefinder, adaptive_rangefinder
...
class TestRangefinder:
    ...
    def test_orthogonality(self, low_rank_matrix):
        ...
        identity = np.eye(r + 5)
        assert_allclose(Q.T @ Q, identity, atol=1e-10, 
                       err_msg="Q columns are not orthonormal")
    ...
    def test_seed_reproducibility(self, low_rank_matrix):
        ...
        assert_allclose(Q1, Q2, atol=1e-14, 
                       err_msg="Same seed should produce identical output")
    ...
    def test_large_matrix_convergence(self, large_low_rank_matrix):
        ...
        for target_r in [20, 30, 40]:
            ...
            if target_r < r:
                ...
                assert error < expected_error * 10, \
