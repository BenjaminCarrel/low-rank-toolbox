...
class TestMaxIterations:
    ...
    def test_max_iter_stops_early(self):
        ...
        krylov_kwargs = {'extended': False}
        with pytest.warns(UserWarning):  # May warn about standard Krylov or no convergence
            X = solve_sylvester(A, B, C, tol=1e-14, max_iter=max_iter, krylov_kwargs=krylov_kwargs)
...
class TestLegacyTests:
    ...
    def test_sylvester_large_low_rank(self):
        ...
        X = solve_sparse_low_rank_sylvester(A, B, C, tol=1e-10, krylov_kwargs={'extended': True})
        Xd = X.todense()
...
class TestKrylovAlgorithms:
    ...
    def test_krylov_spaces_created_for_sylvester(self):
        ...
        from lowrank.krylov.spaces import KrylovSpace, ExtendedKrylovSpace
    ...
    def test_symmetric_matrices_in_sylvester(self):
        ...
        X = solve_sylvester(A, B, C, tol=1e-10, is_A_symmetric=True, is_B_symmetric=True)
    ...
    def test_lanczos_used_for_symmetric_A_and_B(self):
        ...
        X = solve_sparse_low_rank_sylvester(A, B, C, tol=1e-10, 
                                           is_A_symmetric=True, is_B_symmetric=True)
    ...
    def test_special_case_A_equals_B_symmetric(self):
        ...
        print("   Note: When A=B, problem is Lyapunov; use solve_lyapunov() for further optimization")
    ...
    def test_only_A_symmetric(self):
        ...
        X = solve_sylvester(A, B, C, tol=1e-10, is_A_symmetric=True, is_B_symmetric=False)
    ...
    def test_only_B_symmetric(self):
        ...
        X = solve_sylvester(A, B, C, tol=1e-10, is_A_symmetric=False, is_B_symmetric=True)
