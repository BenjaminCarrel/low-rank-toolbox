...
def test_oversampling_sqdeim_return_projection(orthonormal_matrix):
    ...
    p, P_U = oversampling_sQDEIM(
        Q, oversampling_size=oversampling, return_projection=True
    )
...
def test_oversampling_sqdeim_return_both(orthonormal_matrix):
    ...
    p, P_U, inv_U = oversampling_sQDEIM(
        Q, oversampling_size=oversampling, return_projection=True, return_inverse=True
    )
...
def test_oversampling_sqdeim_documentation_example():
    ...
    # With projection
    p, P_U = oversampling_sQDEIM(
        U, oversampling_size=oversampling, return_projection=True
    )
    ...
    # With both outputs
    p, P_U, inv_U = oversampling_sQDEIM(
        U, oversampling_size=oversampling, return_projection=True, return_inverse=True
    )
...
def test_oversampling_sqdeim_reproducibility():
    ...
    # With projector
    _, P_U1 = oversampling_sQDEIM(
        Q, oversampling_size=oversampling, return_projection=True
    )
    _, P_U2 = oversampling_sQDEIM(
        Q, oversampling_size=oversampling, return_projection=True
    )
